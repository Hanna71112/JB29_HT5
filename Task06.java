...
public class Task06 {
	...
	Time time = new Time();
	//System.out.println("Установлено время: " +time.getHour() + ":" +time.getMinute()+":"+time.getSecond());
	time.setHour(6);
	time.setMinute(7);
	time.setSecond(25);
	System.out.println("Установлено время: " +time.getHour() + ":" +time.getMinute()+":"+time.getSecond());
	...
	time.changeTime();
	System.out.print("Измененное время: " +time.getHour() + ":" +time.getMinute()+":"+time.getSecond());
}
